...
public class MainJCF {
    ...
    public static void main(String[] args) {
        ...
        //utilizando la implementacion del priorityQueue
        PriorityQueue<Pacientes> Pacientes = new PriorityQueue<Pacientes>();
        ...
        while(menu) {
            ...
            if(opcion==2) {
                ...
                if(!Pacientes.isEmpty()) {
                    ...
                    //sacando al primer paciente en el priorityqueue
                    siguientePatient = Pacientes.peek();
